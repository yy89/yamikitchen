 ...
 */
    ...
    public String IDCardValidate(String IDString) {
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
        System.out.println(new String(new IDCard().IDCardValidate("330327199301281218").getBytes("iso8859-1"),"UTF-8"));
    }
}

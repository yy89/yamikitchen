...
//
    less.Parser = function Parser(env) {
        ...
        function getLocation(index, inputStream) {
            ...
            if (typeof index === 'number') {
                line = (inputStream.slice(0, index).matc../g
            ) ||
                ""
            ).
                length;
    ...
    (function (tree) {
        ...
        tree.functions = {
            ...
            escape: function (str) {
                return new (tree.Anonymous)(encodeURI(str.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g, "%23").replace(/;/g, "%3B").replac..
                /g, "%28").replac../g, "%29"
                ))
                ;
            },
...
//
                ...
                if (directiveNode.name === "@charset") {
                    ...
                    if (this.charset) {
                        if (directiveNode.debugInfo) {
                            var comment = new tree.Comment("/* " + directiveNode.toCSS(this._env).replac..
                            /g, "")+" */\n
                            ");
    ...
    (function (tree) {
        ...
        tree.sourceMapOutput.prototype.normalizeFilename = function (filename) {
            ...
            return (this._sourceMapRootpath || "") + filename.replac..
            /g, '/
            ');
        };
